...
let gb = prompt('Ведди на скільки Гб флешка?');
let mb = gb*1024;
let filesRound = Math.floor(mb/820);
let filesFixed = (mb/820).toFixed(2);
let files = (mb/820);

alert(`На флешку розміром ${gb} Гб влізе близько ${filesRound} файлів розміром в 820 Мб, а точніше ${filesFixed},  а ще точніше ${files} `); 
...
let barOfShockolad = prompt('enter prise of bars of shockolades');
let quantity = (money/barOfShockolad).toFixed(0);
let costs = barOfShockolad*quantity;
let rest = money-costs;
...
let deposit = prompt('введи суму вкладу на 2 місяці');
